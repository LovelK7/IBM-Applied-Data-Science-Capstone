...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title='Success for a single site: ')
        return fig
...
def get_scatter_plot(entered_site,payload):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(data_frame=filtered2_df,x='Payload Mass (kg)', y='class', 
        title='Correlation between payload and success for single site',
        color='Booster Version Category')
        return fig
